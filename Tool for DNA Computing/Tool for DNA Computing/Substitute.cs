...
namespace Tool_for_DNA_Computing
{
    public partial class Substitute : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                File.WriteAllText(f.SelectedPath + "\\Substitute.txt", txtSub.Text);
                MessageBox.Show("Saved to " + f.SelectedPath + "\\Substitute.txt", "Saved File", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
        }
    }
}
